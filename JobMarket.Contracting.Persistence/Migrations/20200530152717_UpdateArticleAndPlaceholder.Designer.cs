...
namespace JobMarket.Contracting.Persistence.Migrations
{
    ...
    [Migration("20200530152717_UpdateArticleAndPlaceholder")]
    partial class UpdateArticleAndPlaceholder
    {
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 126, DateTimeKind.Local).AddTicks(8877));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.ArticleContract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 142, DateTimeKind.Local).AddTicks(2330));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Clause", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 143, DateTimeKind.Local).AddTicks(9906));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 147, DateTimeKind.Local).AddTicks(2709));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Placeholder", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 150, DateTimeKind.Local).AddTicks(9142));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Template", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 17, 27, 16, 153, DateTimeKind.Local).AddTicks(4893));

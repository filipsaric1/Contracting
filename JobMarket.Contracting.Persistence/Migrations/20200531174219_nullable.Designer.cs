...
namespace JobMarket.Contracting.Persistence.Migrations
{
    ...
    [Migration("20200531174219_nullable")]
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 721, DateTimeKind.Local).AddTicks(4730));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.ArticleContract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 731, DateTimeKind.Local).AddTicks(1826));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Clause", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 732, DateTimeKind.Local).AddTicks(490));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 734, DateTimeKind.Local).AddTicks(1265));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Placeholder", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 736, DateTimeKind.Local).AddTicks(4556));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Template", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 10, 42, 18, 737, DateTimeKind.Local).AddTicks(8160));

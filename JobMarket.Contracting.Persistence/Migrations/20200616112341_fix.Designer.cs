            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 6, 16, 13, 23, 40, 707, DateTimeKind.Local).AddTicks(573));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Clause", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 13, 23, 40, 715, DateTimeKind.Local).AddTicks(7270));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 13, 23, 40, 717, DateTimeKind.Local).AddTicks(6799));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Placeholder", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 13, 23, 40, 719, DateTimeKind.Local).AddTicks(9746));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Template", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 13, 23, 40, 721, DateTimeKind.Local).AddTicks(256));

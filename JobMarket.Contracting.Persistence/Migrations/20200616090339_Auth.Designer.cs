            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 6, 16, 11, 3, 38, 963, DateTimeKind.Local).AddTicks(584));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Clause", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 11, 3, 38, 971, DateTimeKind.Local).AddTicks(4733));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 11, 3, 38, 973, DateTimeKind.Local).AddTicks(4377));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Placeholder", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 11, 3, 38, 975, DateTimeKind.Local).AddTicks(7702));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Template", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 11, 3, 38, 976, DateTimeKind.Local).AddTicks(8438));

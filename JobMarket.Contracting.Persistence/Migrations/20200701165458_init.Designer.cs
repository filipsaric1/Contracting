            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2020, 7, 1, 18, 54, 58, 385, DateTimeKind.Local).AddTicks(248));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Clause", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 1, 18, 54, 58, 398, DateTimeKind.Local).AddTicks(9677));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 1, 18, 54, 58, 401, DateTimeKind.Local).AddTicks(802));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Placeholder", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 1, 18, 54, 58, 403, DateTimeKind.Local).AddTicks(2897));
            ...
            modelBuilder.Entity("JobMarket.Contracting.Domain.Entities.Template", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 1, 18, 54, 58, 404, DateTimeKind.Local).AddTicks(3760));
